...
class PlayVideoAutoPage extends StatefulWidget {
  String url = "";
  bool isFile = false;
  bool isPause = false;
  void Function(int, int) callback;
   PlayVideoAutoPage(
      {Key key, this.url, this.isFile, this.isPause, this.callback})
      : super(key: key);
...
class _PlayVideoPageState extends State<PlayVideoAutoPage> {
  ...
  void initState() {
    ...
    _controller.seekTo(Duration(milliseconds: 1));
    _controller.addListener(() {
      if (_controller.value.isPlaying) {
        if (widget.callback != null) {
          widget.callback(_controller.value.duration.inSeconds,
