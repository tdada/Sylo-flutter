...
import '../../../../../../../app.dart';
import 'completed_sylo_repost_page.dart';

class CompletedSyloRepostPageViewModel {
  CompletedSyloRepostPageState state;
  InterceptorApi interceptorApi;
  SubAlbumData subAlbumData = SubAlbumData();
  List<String> tagList = List();

  CompletedSyloRepostPageViewModel(this.state){
  ...
  initImageModel() {
    subAlbumData = SubAlbumData(
        ...
        directUrl: "Family time on the beach",
