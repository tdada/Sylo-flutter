...
class PlayViewSideAudioWidget extends StatefulWidget {
  final String url;
...
class _PlayerWidgetState extends State<PlayViewSideAudioWidget> with SingleTickerProviderStateMixin {
  String url;
  PlayerMode mode;
