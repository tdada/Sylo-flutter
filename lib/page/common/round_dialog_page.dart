...
class RoundDialogPage extends StatefulWidget {
  String message;
  ...
  RoundDialogPage(this.message, {this.callback, this.email, this.positiveActionText, this.isSuccessIcon});

  @override
  RoundDialogPageState createState() => RoundDialogPageState();
}

class RoundDialogPageState extends State<RoundDialogPage> {
  @override
