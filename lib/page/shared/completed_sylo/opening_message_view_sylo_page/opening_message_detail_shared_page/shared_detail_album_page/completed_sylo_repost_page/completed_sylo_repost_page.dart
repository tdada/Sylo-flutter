...
import '../../../../../../../app.dart';
import 'completed_sylo_repost_page_view_model.dart';

class CompletedSyloRepostPage extends StatefulWidget {
  String from;
  AlbumMediaData albumMediaData;
  CompletedSyloRepostPage({this.from, this.albumMediaData});

  @override
  CompletedSyloRepostPageState createState() => CompletedSyloRepostPageState();
}

class CompletedSyloRepostPageState extends State<CompletedSyloRepostPage> {
  CompletedSyloRepostPageViewModel model;
  ...
  Widget build(BuildContext context) {
    ...
    model ?? (model = CompletedSyloRepostPageViewModel(this));
