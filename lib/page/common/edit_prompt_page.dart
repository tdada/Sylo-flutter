...
class EditPromptPage extends StatelessWidget {
  
  String text="";
  EditPromptPage({this.text});
  final FocusNode myFocusNodeNameSignup = FocusNode();
  TextEditingController nameAlbumController = TextEditingController(text: "text");
...
*/
  ...
  Widget build(BuildContext context) {
    nameAlbumController.text=text.toString();
    nameAlbumController.selection= TextSelection.collapsed(offset: text.length);
