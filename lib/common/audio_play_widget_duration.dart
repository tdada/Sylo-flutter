...
class AudioPlayWidgetDuration extends StatefulWidget {
  final String url;
  final PlayerMode mode = PlayerMode.MEDIA_PLAYER;
  final bool isLocal;
  void Function(double) callback;
  void Function(AudioPlayer _audioPlayer,Duration duration) onPlay;
  void Function() onPause;
  final double icon_size;
  AudioPlayWidgetDuration({@required this.url, this.isLocal, this.callback, this.icon_size, this.onPlay, this.onPause});
...
class _PlayerWidgetState extends State<AudioPlayWidgetDuration> {
  String url;
  PlayerMode mode;
                          ...
                          if (_isPlaying) {
                            ...
                            /*if(widget.gifController!=null) {
                              ...
                              if(widget.onPlay!=null) {
                                widget.onPlay(_audioPlayer,_duration);
